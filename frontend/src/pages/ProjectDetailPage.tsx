            ...
            <Card style={{ marginBottom: '24px' }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
                <div>
                  ...
                  <Text type="secondary">
                    AI has recommended {currentProject.collections.length} themed collections
                  </Text>
                </div>
                <Button 
                  type="primary" 
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' }}>
              <div>
                ...
                <Text type="secondary" style={{ color: '#b0b0b0', fontSize: '14px' }}>
                  AI has generated {currentProject.clips?.length || 0} highlights
                </Text>
              </div>
            ...
            {currentProject.clips && currentProject.clips.length > 0 ? (
              ...
              <div style={{ 
                ...
                <Empty 
                  description={
                    <Text style={{ color: '#888', fontSize: '14px' }}>No Video Clips</Text>
                  }
        ...
        <div>
          ...
          <Card style={{ marginTop: '16px' }}>
            <Empty 
              ...
              description={
                <div>
                  <Text>Project processing not yet complete</Text>
                  <br />
                  <Text type="secondary">Once done, you can view Video Clips and AI Collections</Text>
                </div>
              }
            />
          </Card>
