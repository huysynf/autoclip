...
const MagicWandIcon: React.FC<MagicWandIconProps> = ({ className, style }) => {
  return (
    <svg
      ...
      className={className}
      style={style}
    >{/*Magic wand body - white diagonal lines */}<path
        d="M2 14L14 2"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
      />{/* The top of the magic wand - small diamond */}<path
        d="M12 2L14 4L12 6L10 4L12 2Z"
        fill="currentColor"
      />{/* Star in the upper left corner */}<path
        d="M3 3L3.5 4.5L5 4.5L3.5 5.5L4 7L3 6L2 7L2.5 5.5L1 4.5L2.5 4.5L3 3Z"
        fill="#87CEEB"
      />{/* Star in the lower right corner */}<path
